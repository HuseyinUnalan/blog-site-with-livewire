                            ...
                            <div class="content-block">
                                ...
                                <div class="post-content">
                                    ...
                                    <div class="post-meta-wrapper with-button">
                                        <div class="post-meta">
                                            <div class="post-author-avatar border-rounded">
                                                <img src="{{ asset('frontend/assets/images/post-images/author/author-image-1.png') }}" alt="Author Images">
                                            </div>
                                            <div class="content">
                                                <h6 class="post-author-name">
                                                    <a class="hover-flip-item-wrapper" href="author.html">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="axil-banner mb--30">
                            <div class="thumbnail">
                                <a href="#">
                                    <img class="w-100" src="{{ asset('frontend/assets/images/add-banner/banner-03.png') }}" alt="Banner Images">
                                </a>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="modern-post-activation slick-layout-wrapper axil-slick-arrow arrow-between-side">
                                    ...
                                    <div class="slick-single-layout">
                                        <div class="content-block modern-post-style text-center content-block-column">
                                            ...
                                            <div class="post-thumbnail">
                                                <a href="post-details.html">
                                                    <img src="{{ asset('frontend/assets/images/post-images/post-column-04.jpg') }}" alt="Post Images">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slick-single-layout">
                                        <div class="content-block modern-post-style text-center content-block-column">
                                            ...
                                            <div class="post-thumbnail">
                                                <a href="post-details.html">
                                                    <img src="{{ asset('frontend/assets/images/post-images/post-column-05.jpg') }}" alt="Post Images">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slick-single-layout">
                                        <div class="content-block modern-post-style text-center content-block-column">
                                            ...
                                            <div class="post-thumbnail">
                                                <a href="post-details.html">
                                                    <img src="{{ asset('frontend/assets/images/post-images/post-column-06.jpg') }}" alt="Post Images">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slick-single-layout">
                                        <div class="content-block modern-post-style text-center content-block-column">
                                            ...
                                            <div class="post-thumbnail">
                                                <a href="post-details.html">
                                                    <img src="{{ asset('frontend/assets/images/post-images/post-column-07.jpg') }}" alt="Post Images">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="modern-post-activation slick-layout-wrapper axil-slick-arrow arrow-between-side">
                                    ...
                                    <div class="slick-single-layout">
                                        <div class="content-block modern-post-style text-center content-block-column">
                                            ...
                                            <div class="post-thumbnail">
                                                <a href="post-details.html">
                                                    <img src="{{ asset('frontend/assets/images/post-images/post-column-08.jpg') }}" alt="Post Images">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slick-single-layout">
                                        <div class="content-block modern-post-style text-center content-block-column">
                                            ...
                                            <div class="post-thumbnail">
                                                <a href="post-details.html">
                                                    <img src="{{ asset('frontend/assets/images/post-images/post-column-01.jpg') }}" alt="Post Images">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slick-single-layout">
                                        <div class="content-block modern-post-style text-center content-block-column">
                                            ...
                                            <div class="post-thumbnail">
                                                <a href="post-details.html">
                                                    <img src="{{ asset('frontend/assets/images/post-images/post-column-02.jpg') }}" alt="Post Images">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="modern-post-activation slick-layout-wrapper axil-slick-arrow arrow-between-side">
                                    ...
                                    <div class="slick-single-layout">
                                        <div class="content-block modern-post-style text-center content-block-column">
                                            ...
                                            <div class="post-thumbnail">
                                                <a href="post-details.html">
                                                    <img src="{{ asset('frontend/assets/images/post-images/post-column-03.jpg') }}" alt="Post Images">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row trend-tab-content tab-pane fade show active" id="trendone" role="tabpanel" aria-labelledby="trend-one">
                            <div class="col-lg-8">
                                ...
                                <div class="content-block trend-post post-order-list axil-control">
                                    ...
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="{{ asset('frontend/assets/images/post-images/trend-post-01.jpg') }}" alt="Post Images">
                                        </a>
                                    </div>
                                </div>
                                <!-- End Single Post  -->
                                ...
                                <div class="content-block trend-post post-order-list is-active">
                                    ...
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="{{ asset('frontend/assets/images/post-images/trend-post-02.jpg') }}" alt="Post Images">
                                        </a>
                                    </div>
                                </div>
                                <!-- End Single Post  -->
                                ...
                                <div class="content-block trend-post post-order-list axil-control">
                                    ...
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="{{ asset('frontend/assets/images/post-images/trend-post-03.jpg') }}" alt="Post Images">
                                        </a>
                                    </div>
                                </div>
                                <!-- End Single Post  -->
                                ...
                                <div class="content-block trend-post post-order-list axil-control">
                                    ...
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="{{ asset('frontend/assets/images/post-images/trend-post-04.jpg') }}" alt="Post Images">
                                        </a>
                                    </div>
                                </div>
                                <!-- End Single Post  -->
